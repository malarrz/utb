...
function cargarLugares(map) {
  ...
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -68.12;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/tiendas/cerca?lat=".concat(lat, "&lng=").concat(lng)).then(function (res) {
    ...
    var marcadores = lugares.map(function (place) {
      var _place$ubicacion$coor = _slicedToArray(place.ubicacion.coordenadas, 2),
        ...
        lugarLat = _place$ubicacion$coor[1];
      var position = {
        lat: lugarLat,
        lng: lugarLng
      };
...
/***/ "./public/javascripts/modules/textoBusqueda.js":
/*!*****************************************************!*\
  !*** ./public/javascripts/modules/textoBusqueda.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function resultadosBusquedaHTML(tiendas) {
  return tiendas.map(function (tienda) {
    return "\n            <a href=\"/tiendas/".concat(tienda.slug, "\" class=\"search__result\">\n                <strong>").concat(tienda.nombre, "</strong>\n            </a>\n        ");
  }).join('');
}
function textoBusqueda(search) {
  if (!search) return;
  var busquedaTexto = search.querySelector('input[name="search"]');
  var busquedaResultados = search.querySelector('.search__results');
  busquedaTexto.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      if (res.data.length) {
        busquedaResultados.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(resultadosBusquedaHTML(res.data));
        return;
      }
      busquedaResultados.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("<div class=\"search__result\">No hay resultados de la b\xFAsqueda '".concat(_this.value, "'</div>"));
    }).catch(function (err) {
      console.error(err);
    });
  });
  //Navegación de la búsqueda con teclado arriba, abajo, enter
  busquedaTexto.on('keyup', function (e) {
...
/* harmony default export */ __webpack_exports__["default"] = (textoBusqueda);
